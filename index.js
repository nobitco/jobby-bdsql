...
const setupJobModel = require('./models/job')
const setupTutorModel = require('./models/tutor')
const setupAsignmentModel = require('./models/asignment')
...
const setupTutor = require('./lib/tutor')
const setupAsignment = require('./lib/asignment')
...
module.exports = async function (config) {
  ...
  const Tutor = setupTutor(TutorModel)
  const Asignment = setupAsignment(AsignmentModel)
  return {
    User,
    Student,
    Coordinator,
